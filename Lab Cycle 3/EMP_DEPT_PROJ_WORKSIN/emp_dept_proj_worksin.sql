...
CHECK(SALARY BETWEEN 30000 AND 75000)
);
...
DESCRIBE PROJECT;
DESCRIBE WORK_IN;
INSERT INTO EMPLOYEE(ENAME,DESIGN,DNO,DOJ,SALARY)VALUES('Abhi','HR',2,'2009-04-12',70000 ),
('bhama','admin',1,'2008-03-10',75000 ),('chriz','sales',3,'2015-06-23',35000 ),
('diya','production',5,'2015-07-21',32000 ),('govind','production',5,'2015-09-12',35000 ),
('hima','finance',4,'2013-01-19',51000 ),('ira','hr',2,'2010-03-15',45000 ),
('sandeep','finance',4,'2010-07-26',49000 );
...
SELECT d.dname,d.dnumber,e.ssn,e.ename,e.design,e.doj,e.salary FROM department
d,employee e WHERE (SELECT COUNT(*) FROM employee e WHERE e.dno = d.dnumber
AND e.salary>40000)>4 AND e.dno=d.dnumber GROUP BY d.dname,d.dnumber,e.ssn,e.ename,e.design,e.doj,e.salary;
create VIEW EMP_DEPT_VIEW as select  * from EMPLOYEE NATURAL JOIN department;
CREATE SYNONYM EMP_DEPTS FOR EMP_DEPT_VIEW;
