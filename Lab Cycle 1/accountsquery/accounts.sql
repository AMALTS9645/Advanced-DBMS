...
SELECT * FROM LOAN_ACCOUNTS;
Update Loan_Accounts 
set INTEREST=(Loan_amount * Int_rate* installment)/(12*100) ;
SELECT * FROM LOAN_ACCOUNTS;
delete from LOAN_ACCOUNTS 
where START_DATE < '2008-01-01';
SELECT * FROM LOAN_ACCOUNTS;
delete FROM LOAN_ACCOUNTS 
where CUST_NAME like 'K%';
SELECT * FROM LOAN_ACCOUNTS;
SELECT * FROM LOAN_ACCOUNTS 
where INSTALLMENT < 40;
SELECT ACCNO, Loan_amount FROM LOAN_ACCOUNTS
 where START_DATE < '2009-04-01';
 SELECT Int_rate FROM LOAN_ACCOUNTS 
 where START_DATE > '2009-04-01';
 ...
 SELECT ACCNO, CUST_NAME, Loan_amount 
 FROM LOAN_ACCOUNTS where NOT(CUST_NAME like '%P%');
 DESCRIBE LOAN_ACCOUNTS;
